...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/bitvio/logo.png" })));
};
...
var Icon$v = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/bitvio/9.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/bitvio/9.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 160 26" }, props),
        React__default['default'].createElement("path", { d: "M13.02,1.04c0.51,0,1,0.1,1.47,0.31s0.89,0.48,1.25,0.83c0.36,0.35,0.64,0.75,0.85,1.22c0.21,0.47,0.32,0.97,0.32,1.51\n\t\t\tv1.86c0,0.64-0.15,1.25-0.46,1.81c-0.31,0.56-0.72,1.02-1.25,1.37c0.51,0.36,0.92,0.81,1.23,1.36c0.31,0.55,0.47,1.16,0.47,1.82\n\t\t\tv1.86c0,0.51-0.1,1-0.31,1.46c-0.2,0.47-0.48,0.88-0.83,1.23c-0.35,0.36-0.76,0.64-1.23,0.85c-0.48,0.21-0.98,0.32-1.53,0.32H0\n\t\t\tV1.04H13.02z M12.51,6.44c0-0.19-0.01-0.38-0.04-0.58S12.4,5.46,12.32,5.3c-0.08-0.16-0.19-0.3-0.33-0.41\n\t\t\tc-0.14-0.11-0.33-0.17-0.57-0.17H4.38v3.43h7.04c0.31,0,0.56-0.11,0.78-0.33c0.21-0.22,0.32-0.48,0.32-0.79V6.44z M12.51,12.82\n\t\t\tc0-0.29-0.11-0.54-0.32-0.76c-0.21-0.22-0.47-0.33-0.78-0.33H4.38v3.43h7.04c0.31,0,0.56-0.11,0.78-0.32s0.32-0.47,0.32-0.78\n\t\t\tV12.82z" }),
        React__default['default'].createElement("path", { d: "M23.73,0v3.54h-4.09V0H23.73z M23.73,5.06v13.79h-4.09V5.06H23.73z" }),
        React__default['default'].createElement("path", { d: "M32.02,14.4c0,0.29,0.09,0.53,0.28,0.71c0.19,0.19,0.42,0.28,0.71,0.28h2.92v3.46h-4.55c-0.47,0-0.92-0.09-1.35-0.27\n\t\t\tc-0.42-0.18-0.79-0.43-1.11-0.75c-0.31-0.32-0.56-0.69-0.75-1.11c-0.19-0.42-0.28-0.87-0.28-1.36V8.52h-2.29V5.06h2.29V1.83h4.12\n\t\t\tv3.23h4.04v3.46h-4.04V14.4z" }),
        React__default['default'].createElement("path", { d: "M53.28,5.06l-6.08,13.79h-3.99L37.13,5.06h4.42l3.61,9.44h0.03l3.61-9.44H53.28z" }),
        React__default['default'].createElement("path", { d: "M59.11,0v3.54h-4.09V0H59.11z M59.11,5.06v13.79h-4.09V5.06H59.11z" }),
        React__default['default'].createElement("path", { d: "M72.36,5.06c0.46,0,0.9,0.09,1.32,0.27c0.42,0.18,0.8,0.43,1.12,0.75c0.32,0.32,0.58,0.7,0.76,1.12\n\t\t\tc0.19,0.42,0.28,0.87,0.28,1.35v6.82c0,0.46-0.09,0.9-0.27,1.32c-0.18,0.42-0.42,0.8-0.74,1.12c-0.31,0.32-0.68,0.58-1.11,0.76\n\t\t\tc-0.42,0.19-0.88,0.28-1.37,0.28h-7.07c-0.46,0-0.9-0.09-1.32-0.27s-0.79-0.43-1.11-0.75c-0.31-0.32-0.57-0.69-0.76-1.11\n\t\t\tc-0.2-0.42-0.29-0.87-0.29-1.36V8.55c0-0.46,0.09-0.9,0.27-1.32c0.18-0.42,0.43-0.79,0.75-1.11c0.32-0.31,0.69-0.57,1.11-0.76\n\t\t\tc0.42-0.19,0.87-0.29,1.36-0.29H72.36z M71.72,9.51c0-0.29-0.1-0.53-0.29-0.71c-0.2-0.19-0.43-0.28-0.7-0.28h-3.82\n\t\t\tc-0.27,0-0.5,0.09-0.7,0.28c-0.2,0.19-0.29,0.42-0.29,0.71v4.88c0,0.29,0.1,0.53,0.29,0.71c0.19,0.19,0.43,0.28,0.7,0.28h3.82\n\t\t\tc0.27,0,0.5-0.09,0.7-0.28s0.29-0.42,0.29-0.71V9.51z" }),
        React__default['default'].createElement("path", { d: "M84.01,4.76c-0.29,0-0.53,0.1-0.72,0.31c-0.2,0.2-0.29,0.45-0.29,0.74v1.17c0,0.29,0.1,0.53,0.29,0.73\n\t\t\tc0.19,0.19,0.44,0.29,0.72,0.29h7.58c0.51,0,1,0.1,1.46,0.31c0.47,0.2,0.88,0.48,1.23,0.83c0.36,0.35,0.64,0.75,0.85,1.22\n\t\t\ts0.32,0.97,0.32,1.51v3.13c0,0.51-0.1,1-0.3,1.46s-0.48,0.88-0.83,1.23s-0.75,0.64-1.22,0.85c-0.47,0.21-0.97,0.32-1.51,0.32\n\t\t\th-9.16c-0.51,0-1-0.1-1.46-0.31c-0.47-0.2-0.88-0.47-1.25-0.81c-0.37-0.34-0.65-0.74-0.87-1.21s-0.32-0.97-0.32-1.51v-1.58h4.4\n\t\t\tv0.58c0,0.31,0.11,0.57,0.32,0.79s0.47,0.33,0.78,0.33h6.03c0.29,0,0.53-0.1,0.72-0.31s0.29-0.45,0.29-0.74v-1.37\n\t\t\tc0-0.29-0.1-0.53-0.29-0.74c-0.2-0.2-0.44-0.31-0.72-0.31h-7.55c-0.51,0-1-0.11-1.48-0.32s-0.89-0.5-1.25-0.85\n\t\t\tc-0.36-0.36-0.64-0.77-0.85-1.25c-0.21-0.47-0.32-0.98-0.32-1.53V4.91c0-0.51,0.1-1,0.3-1.46c0.2-0.47,0.48-0.88,0.83-1.23\n\t\t\tc0.35-0.36,0.76-0.64,1.23-0.85c0.47-0.21,0.98-0.32,1.53-0.32h8.72c0.51,0,1,0.1,1.46,0.31c0.47,0.2,0.88,0.48,1.25,0.83\n\t\t\tc0.36,0.35,0.65,0.76,0.86,1.23c0.21,0.48,0.32,0.98,0.32,1.5v1.58h-4.4V5.88c0-0.31-0.11-0.57-0.32-0.79\n\t\t\tc-0.21-0.22-0.47-0.33-0.78-0.33H84.01z" }),
        React__default['default'].createElement("path", { d: "M110.46,5.06l2.37,9.41l2.24-9.41h4.5l-4.63,13.79h-4.09l-2.47-9.23l-2.47,9.23h-4.09L97.18,5.06h4.5l2.26,9.41l2.34-9.41\n\t\t\tH110.46z" }),
        React__default['default'].createElement("path", { d: "M134.8,18.85h-4.12v-2.24l-2.54,2.24h-3.51c-0.49,0-0.95-0.1-1.37-0.29c-0.42-0.19-0.8-0.45-1.12-0.76\n\t\t\tc-0.32-0.31-0.57-0.68-0.75-1.11c-0.18-0.42-0.27-0.86-0.27-1.32V8.55c0-0.47,0.1-0.92,0.29-1.35c0.19-0.42,0.45-0.8,0.78-1.12\n\t\t\tc0.32-0.32,0.7-0.57,1.12-0.75c0.42-0.18,0.87-0.27,1.32-0.27h10.17V18.85z M129.69,15.39c0.29,0,0.53-0.09,0.71-0.28\n\t\t\tc0.19-0.19,0.28-0.42,0.28-0.71V8.52h-4.45c-0.29,0-0.53,0.09-0.71,0.28c-0.19,0.19-0.28,0.42-0.28,0.71v4.88\n\t\t\tc0,0.29,0.09,0.53,0.28,0.71s0.42,0.28,0.71,0.28H129.69z" }),
        React__default['default'].createElement("path", { d: "M137.7,8.55c0-0.46,0.09-0.9,0.28-1.32s0.44-0.8,0.75-1.12c0.31-0.32,0.68-0.58,1.11-0.76c0.42-0.19,0.87-0.28,1.35-0.28\n\t\t\th6.97c0.46,0,0.9,0.09,1.32,0.27c0.42,0.18,0.8,0.43,1.12,0.75c0.32,0.32,0.58,0.7,0.78,1.12c0.19,0.42,0.29,0.87,0.29,1.35v6.82\n\t\t\tc0,0.46-0.09,0.9-0.28,1.32c-0.19,0.42-0.44,0.79-0.75,1.11c-0.31,0.31-0.69,0.57-1.12,0.76c-0.43,0.2-0.89,0.29-1.36,0.29h-3.79\n\t\t\tl-2.54-2.24v7.53h-4.12V8.55z M141.82,14.4c0,0.27,0.09,0.5,0.28,0.7s0.42,0.29,0.71,0.29h3.74c0.27,0,0.5-0.09,0.7-0.28\n\t\t\tc0.2-0.19,0.29-0.42,0.29-0.71V9.51c0-0.29-0.1-0.53-0.29-0.71c-0.19-0.19-0.43-0.28-0.7-0.28h-3.74c-0.29,0-0.53,0.09-0.71,0.28\n\t\t\tc-0.19,0.19-0.28,0.42-0.28,0.71V14.4z" })));
};
...
var Icon$$ = function (props) {
    return (React__default['default'].createElement("svg", { version: "1.1", id: "Layer_1", xmlns: "http://www.w3.org/2000/svg", x: "0px", y: "0px", width: "32px", height: "24px", viewBox: "0 0 32 24", "enable-background": "new 0 0 32 24" },
        React__default['default'].createElement("image", { id: "image0", width: "32", height: "24", x: "0", y: "0", href: "/images/bitvio/logo-mini.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Bitvio home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Bitvio home page" }, innerLogo))));
};
...
var MenuLink = function (_a) {
    ...
    var isZCore = (href === null || href === void 0 ? void 0 : href.startsWith("https://exchange.bitvio.id")) || (href === null || href === void 0 ? void 0 : href.startsWith("https://app.bitvio.id")) || (href === null || href === void 0 ? void 0 : href.startsWith("https://finance.bitvio.id")) || (href === null || href === void 0 ? void 0 : href.startsWith("/")) || (href === null || href === void 0 ? void 0 : href.startsWith("https://swap.bitvio.id"));
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#0b2b27", invertedContrast: "#FFFFFF", input: "#e5e5e5", tertiary: "#f4eff5", text: "#8a0078", textDisabled: "#BDC2C4", textSubtle: "#8a0078", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #f6e6ff 0%, #f8efff 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#8a0078", tertiary: "#353547", text: "#bf00d6", textDisabled: "#666171", textSubtle: "#bf00d6", borderColor: "#524B63", card: "#27262c", gradients: {
